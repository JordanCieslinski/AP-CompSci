...
public class QuizzesRunner 
{
   public static void main(String[] args) 
   {
      ...
      Quizzes testQuizzes = new Quizzes(scoresArray);
      ...
      correctAns = true;
      int [] testScores = testQuizzes.getDayScores("Monday");      
      ...
      correctAns = true;
      testScores = testQuizzes.getDayScores("Tuesday");
      ...
      // Check Part B
      bestDayForQuizzes = testQuizzes.bestDay();

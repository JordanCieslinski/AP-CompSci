...
public class Student {
    ...
    // Default Constructor: Set name to Caleb and test1 to 50, update studentCounter
    // by 1
    public Student() {
        name = "Caleb";
        test1 = 50;
    ...
    // Overloaded Constructor: Set all the fields to their respective parameters,
    // update studentCounter by 1
